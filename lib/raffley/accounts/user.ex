defmodule Raffley.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Raffley.Repo)
  ...
  """
  def valid_password?(%Raffley.Accounts.User{hashed_password: hashed_password}, password)
